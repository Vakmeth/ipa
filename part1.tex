...
Die Änderungskontrolle dient der Übersicht, wann Änderungen an der Dokumentation vorgenommen wurden.
\begin{table}[h!]
...
\subsection{Meetings}
Während des Scrum Prozesses werden diverse Meetings abgehalten.
...
Die Projektaufbauorganisation beschreibt die Rollen und Personen welche den Kandidaten in der IPA unterstützen.

\section{Projektrollen Scrum}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth,]{scrum_roles_ipa.png}
...
Es werden die Risiken und Massnahmen in Bezug auf das Projekt beschrieben.
...
Es werden die Arbeitsjournale der Arbeitstage während der IPA aufgeführt.
